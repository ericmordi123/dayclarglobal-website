...
@section('content')
	...
	<!-- One -->
	@if (!is_null($pageModel->sectionOneHeading) || !is_null($pageModel->sectionSubOneHeading))
	...
	@if (!is_null($pageModel->sectionTwoHeading) || !is_null($pageModel->sectionSubTwoHeading))
	<section id="two" class="wrapper style3 services-bg" 
		style="background: url({{!is_null($pageModel->sectionTwoBgImg) ? $pageModel->baseUrl . $pageModel->sectionTwoBgImg->data->url : 'test'}})">
		<div class="inner">
